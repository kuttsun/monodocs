...
const EN = {
  ...
  "pages.aliasShadowed":
    'Alias "{alias}" in "{path}" is shadowed by the page "{page}", which already answers to that ' +
    "route. The page wins and the alias has no effect; remove it or point it at a route no page uses.",
...
const JA: Record<MessageKey, string> = {
  ...
  "pages.aliasShadowed":
    '"{path}" の別名 "{alias}" は、その route に既に応答しているページ "{page}" に隠されています。' +
    "ページが勝つので別名は効きません。削除するか、どのページも使っていない route を指してください。",
