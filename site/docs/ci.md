  ...
  validate:
    ...
    steps:
      ...
      - uses: actions/setup-node@v4
        with:
          node-version: 22
      - run: npx --yes monodocs@0.6.0 validate ./docs
```
  ...
  build:
    ...
    steps:
      ...
      - name: Build HTML and PDF
        run: npx --yes monodocs@0.6.0 build ./docs --format both -o ./dist
...
docs:
  ...
  script:
    - npx --yes monodocs@0.6.0 validate ./docs
    - npx --yes monodocs@0.6.0 build ./docs -o ./dist/manual.html
  artifacts:
    paths: [dist/]
```
